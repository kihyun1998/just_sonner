...
- The hover region is the box around the toasts in the window, gaps included, so moving the
  pointer between two toasts does not collapse the deck. A toast exiting from the window stays in
